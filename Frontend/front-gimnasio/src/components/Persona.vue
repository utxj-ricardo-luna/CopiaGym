<template>
    <form action="#">
        <div class="grid gap-12 mb-12 sm:grid-cols-3">
            ...
            <div>
                <label for="Primer Apellido" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Primer
                    apellido</label>
            ...
            <div>
                <label for="titulo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Titulo de
                    cortesía</label>
            ...
            <div>
                <label for="fechan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Fecha de
                    nacimiento</label>
            ...
            <div>
                <label for="genero" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Selecciona el
                    genero</label>
                <select id="countries"
            ...
            <div>
                <label for="sangre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Selecciona tipo
                    de sangre</label>
                <select id="countries"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
